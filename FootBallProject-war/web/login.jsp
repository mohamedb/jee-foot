    ...
    <div class="col-md-5">
        <div class="login_container">
            <form id="login_form"  method="post" action="index"  class="form-horizontal">
                <h2 class="heading_a"><span class="heading_text">Authentification Root</span></h2>
            ...
            <b class="heading_a pull-right">
                <span class="heading_text">
                    <a href="loginEntraineur.jsp" class="btn btn-sm">Se connecter en tant qu'entraineur</a>
                </span>
            </b>
